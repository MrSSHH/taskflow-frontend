    ...
    <Swiper>
      <SwiperSlide>
        ...
        <IonText>
          ...
          <p>
            Manage all your tasks in one place and stay on top of what matters.
          </p>
        </IonText>
      ...
      <SwiperSlide>
        ...
        <IonText>
          ...
          <p>
            Focus on what’s important by assigning priorities and due dates to
            your tasks.
          </p>
        </IonText>
        <SwiperButtonNext>Next</SwiperButtonNext>
      ...
      <SwiperSlide>
        ...
        <IonText>
          ...
          <p>
            Visualize your accomplishments and stay motivated by checking off
            completed tasks.
          </p>
        </IonText>
